...
function Hero() {
  return (
    <>
      <div className="flex flex-col md:flex-row gap-10 items-center justify-center p-8 md:p-16 bg-white text-[#465C47]">
  <div className=" md:text-left lg:ml-40 ">
    <h1 className="text-5xl md:text-5xl mb-4  font-Messiri">Your <br /> Rental Journey <br /> Begins Here</h1>
